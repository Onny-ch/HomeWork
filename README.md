...
- функции получения данных транзакций из файла, функция конвертации валют
- добавлено логирование модулей masks.py и utils.py
- добавлен модуль для чтения CSV и Excel файлов
- добавлены функции фильтрации транзакций строкой и счета количества операций по категориям
